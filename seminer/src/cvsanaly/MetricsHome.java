...
public class MetricsHome {
	...
	public Metrics merge(Metrics detachedInstance) {
		...
		try {
			Metrics result = (Metrics) sessionFactory.getCurrentSession()
	...
	public Metrics findById(int id) {
		log.debug("getting Metrics instance with id: " + id);
		try {
			Metrics instance = (Metrics) sessionFactory.getCurrentSession()
					.get("cvsanaly.Metrics", id);
			if (instance == null) {
	...
	public List findByExample(Metrics instance) {
		log.debug("finding Metrics instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("cvsanaly.Metrics")
