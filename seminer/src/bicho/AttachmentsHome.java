...
public class AttachmentsHome {
	...
	public Attachments merge(Attachments detachedInstance) {
		...
		try {
			Attachments result = (Attachments) sessionFactory
	...
	public Attachments findById(java.lang.Integer id) {
		...
		try {
			Attachments instance = (Attachments) sessionFactory
					.getCurrentSession().get("bicho.Attachments", id);
			if (instance == null) {
	...
	public List findByExample(Attachments instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("bicho.Attachments")
