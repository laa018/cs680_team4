...
public class CommentsHome {
	...
	public Comments merge(Comments detachedInstance) {
		...
		try {
			Comments result = (Comments) sessionFactory.getCurrentSession()
	...
	public Comments findById(java.lang.Integer id) {
		...
		try {
			Comments instance = (Comments) sessionFactory.getCurrentSession()
					.get("bicho.Comments", id);
			if (instance == null) {
